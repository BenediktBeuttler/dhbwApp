...
public class StatisticsScreen extends FragmentActivity implements
	...
	public static class Overview extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			// Create a new TextView and set its text to the fragment's section
			// number argument value.
			View v = inflater.inflate(R.layout.statistics_screen_overview_fragment, null);
			return v;
		}
	}
	...
	public static class Progress extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			// Create a new TextView and set its text to the fragment's section
			// number argument value.
			View v = inflater.inflate(R.layout.statistics_screen_progress_fragment, null);
			return v;
		}
	}
	...
	public static class LastReview extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			// Create a new TextView and set its text to the fragment's section
			// number argument value.
			View v = inflater.inflate(R.layout.statistics_screen_lastreview_fragment, null);
			return v;
		}
	}
